pub mod armor_name {
    ...
    pub static ARMOR_NAME: Lazy<Mutex<HashMap<u32, &str>>> = Lazy::new(|| {
        Mutex::new(HashMap::from([
            ...
            // 1.17 Tarnished Pack. Row IDs verified against the 1.17
            // regulation protector table; piece names per community
            // guides (Leontiel/Steel/Silver Grooved/Broken Mask sets).
            // Altered rows inferred by model+1/next-icon/lighter pattern.
