pub mod event_flags {
    ...
    pub static EVENT_FLAGS: Lazy<Mutex<HashMap<u32,(u32,u8)>>> = Lazy::new(|| {
        Mutex::new(HashMap::from([
            ...
            (68400,(0x8fc,7)),
            (68410,(0x8fd,5)),
            (68510,(0x909,1)), // Forager Brood Cookbook[6]
            (68520,(0x90b,7)), // Forager Brood Cookbook[1]
            (68530,(0x90c,5)), // Forager Brood Cookbook[2]
            (68540,(0x90d,3)), // Forager Brood Cookbook[3]
            (68550,(0x90e,1)), // Forager Brood Cookbook[4]
            (68560,(0x910,7)), // Forager Brood Cookbook[5]
            (68570,(0x911,5)), // Igon's Cookbook[2]
            (68580,(0x912,3)), // Finger-Weaver's Cookbook[2]
            (68590,(0x913,1)), // Greater Potentate's Cookbook[1]
            (68600,(0x915,7)), // Greater Potentate's Cookbook[4]
            (68610,(0x916,5)), // Greater Potentate's Cookbook[5]
            (68620,(0x917,3)), // Greater Potentate's Cookbook[12]
            (68630,(0x918,1)), // Greater Potentate's Cookbook[7]
            (68640,(0x91a,7)), // Greater Potentate's Cookbook[9]
            (68650,(0x91b,5)), // Greater Potentate's Cookbook[10]
            (68660,(0x91c,3)), // Greater Potentate's Cookbook[11]
            (68670,(0x91d,1)), // Mad Craftsman's Cookbook[2]
            (68680,(0x91f,7)), // Greater Potentate's Cookbook[8]
            (68690,(0x920,5)), // Greater Potentate's Cookbook[3]
            (68700,(0x921,3)), // Greater Potentate's Cookbook[13]
            (68710,(0x922,1)), // Greater Potentate's Cookbook[14]
            (68720,(0x924,7)), // Greater Potentate's Cookbook[6]
            (68730,(0x925,5)), // Greater Potentate's Cookbook[2]
            (68740,(0x926,3)), // Ancient Dragon Knight's Cookbook[1]
            (68750,(0x927,1)), // Mad Craftsman's Cookbook[1]
            (68760,(0x929,7)), // St Trina Disciple's Cookbook[1]
            (68770,(0x92a,5)), // Fire Knight's Cookbook[1]
            (68780,(0x92b,3)), // Ancient Dragon Knight's Cookbook[2]
            (68790,(0x92c,1)), // Loyal Knight's Cookbook
            (68800,(0x92e,7)), // Battlefield Priest's Cookbook[1]
            (68810,(0x92f,5)), // Igon's Cookbook[1]
            (68820,(0x930,3)), // Battlefield Priest's Cookbook[2]
            (68830,(0x931,1)), // Forager Brood Cookbook[7]
            (68840,(0x933,7)), // St Trina Disciple's Cookbook[3]
            (68850,(0x934,5)), // Grave Keeper's Cookbook[2]
            (68860,(0x935,3)), // Antiquity Scholar's Cookbook[2]
            (68870,(0x936,1)), // Tibia's Cookbook
            (68880,(0x938,7)), // Mad Craftsman's Cookbook[3]
            (68890,(0x939,5)), // Battlefield Priest's Cookbook[3]
            (68900,(0x93a,3)), // Fire Knight's Cookbook[2]
            (68910,(0x93b,1)), // Antiquity Scholar's Cookbook[1]
            (68920,(0x93d,7)), // Finger-Weaver's Cookbook[1]
            (68930,(0x93e,5)), // Battlefield Priest's Cookbook[4]
            (68940,(0x93f,3)), // Grave Keeper's Cookbook[1]
            (68950,(0x940,1)), // St Trina Disciple's Cookbook[2]
            (10000040,(0x151bd4,7)),
            (10000041,(0x151bd4,6)),
            (10000042,(0x151bd4,5)),
            (10000043,(0x151bd4,4)),
